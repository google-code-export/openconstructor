 ...
 * 
 * $Id: phpinclude.php,v 1.9 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_phpsource.php">
	<input type="hidden" name="action" value="edit_phpinclude">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td colspan="2"><input type="checkbox" name="once" value="true"<?=$obj->once?' CHECKED':''?>> <?=PR_INCLUDE_ONCE?></td>
		</tr>
	</table>
	</fieldset><br>
	<div align="right">
