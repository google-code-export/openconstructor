 ...
 * 
 * $Id: edit_htmltext.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<title><?=WC.' | '.EDIT_DS_HTMLTEXT.' | '.htmlspecialchars($_ds->name, ENT_COMPAT, 'UTF-8')?></title>
