 ...
 * 
 * $Id: userslogout.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_users.php">
	<input type="hidden" name="action" value="edit_userslogout">
	...
	<table style="margin:5 0" cellspacing="3">
		<tr>
			<td colspan="2"><input type=checkbox name="killSession" <?=$obj->killSession ? 'checked' : '' ?>> <?=PR_KILL_SESSION?></td>
		</tr>
	</table>
	</fieldset><br>
	<div align="right">
