 ...
 * 
 * $Id: eventhlintro.php,v 1.10 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_event.php">
	<input type="hidden" name="action" value="edit_eventhlintro">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td nowrap><?=PR_EVENTS_PER_PAGE?>:</td>
		...
		<tr>
			<td nowrap><?=PR_EVENT_MORE_HREF_TEXT?>:</td>
		...
		<tr>
			<td nowrap colspan=2><input type=checkbox name="comingEventsOnly" value="true" <?=@$obj->comingEventsOnly?'checked':''?>> <?=PR_SHOW_COMING_EVENTS_ONLY?></td>
		</tr>
		<tr>
