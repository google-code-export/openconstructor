...
<form name="f" method="POST" action="i_hybrid.php">
	<input type="hidden" name="action" value="edit_hybridtree">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td nowrap><?=PR_TREE_DEEPNESS?>:</td>
			<td><input type="text" name="deepness" value="<?=$obj->deepness?>"></td>
		</tr>
		<tr>
			<td colspan="2"><input type="checkbox" name="countDocs" value="true" <?=$obj->countDocs ? 'checked' : ''?>> <?=PR_COUNT_NODE_DOCS?></td>
		</tr>
		<tr>
	...
	<fieldset id="objFields" style="padding:10"><legend><?=PR_TREE_FIELDS?></legend>
