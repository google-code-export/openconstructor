 ...
 * 
 * $Id: articlehlintro.php,v 1.8 2007/03/02 10:06:41 sanjar Exp $
 */
...
<br>
<h3><?=EDIT_OBJECT?></h3>
<form name="f" method="POST" action="i_article.php">
	<input type="hidden" name="action" value="edit_articlehlintro">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td nowrap><?=PR_ARTICLES_PER_PAGE?>:</td>
