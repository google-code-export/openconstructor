...
<form name="f" method="POST" action="i_guestbook.php">
	<input type="hidden" name="action" value="edit_gbmsghl">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td nowrap><?=PR_OFFSET?>:</td>
			<td><input type="text" name="offset" value="<?=$obj->offset?$obj->offset:0?>"></td>
		</tr>
		<tr>
			<td nowrap><?=PR_MESSAGES_PER_PAGE?>:</td>
		...
		<tr>
			<td nowrap colspan=2><input type=checkbox name="fetchcontent" value="true" <?=@$obj->fetchContent?'checked':''?>> <?=PR_GB_FETCH_CONTENT?></td>
		</tr>
		<tr>
			<td nowrap colspan=2><input type=checkbox name="showunpublished" value="true" <?=@$obj->showUnpublished?'checked':''?>> <?=PR_GB_SHOW_UNPUBLISHED?></td>
		</tr>
		<tr>
