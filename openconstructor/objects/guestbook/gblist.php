 ...
 * 
 * $Id: gblist.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_guestbook.php">
	<input type="hidden" name="action" value="edit_gblist">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td nowrap><?=PR_GB_URI?>:</td>
			<td><input type="text" name="srvuri" value="<?=$obj->srvuri?>"></td>
		</tr>
		<tr>
			<td nowrap><?=PR_GB_ID?>:</td>
			<td><input type="text" name="gbid" value="<?=$obj->gbid?>"></td>
		</tr>
		<tr>
