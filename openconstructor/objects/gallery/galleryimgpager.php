 ...
 * 
 * $Id: galleryimgpager.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_gallery.php">
	<input type="hidden" name="action" value="edit_galleryimgpager">
...
<?
	...
	$types=array('galleryimage');
	include('../select_obj._wc');
?>
