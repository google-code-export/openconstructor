 ...
 * 
 * $Id: galleryhl.php,v 1.9 2007/03/02 10:06:41 sanjar Exp $
 */
...
function setdynamic(stat){
	f.all('ds_id[]').disabled=!(f.dyn_ds_id.disabled=!stat);
}
</script>
</head>
...
<form name="f" method="POST" action="i_gallery.php">
	<input type="hidden" name="action" value="edit_galleryhl">
...
?>	
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			<td nowrap><?=PR_IMAGES_PER_PAGE?>:</td>
			<td><input type="text" name="pagesize" value="<?=$obj->pageSize?>"></td>
		</tr>
		<tr>
			<td nowrap><?=PR_CUT_NAMES?>:</td>
