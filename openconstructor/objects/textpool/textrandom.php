 ...
 * 
 * $Id: textrandom.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<br>
<h3><?=EDIT_OBJECT?></h3>
<form name="f" method="POST" action="i_textpool.php">
	<input type="hidden" name="action" value="edit_textrandom">
