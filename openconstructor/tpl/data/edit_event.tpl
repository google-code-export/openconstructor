...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>{$smarty.const.WC} | {$smarty.const.EDIT_DS_EVENT} | {$ds_name}</title>
	...
	<body>
		<h3>{$smarty.const.EDIT_DS_EVENT}</h3>
		{$reportResult}
		<form name="f" method="POST" action="i_data.php">
			<input type="hidden" name="action" value="edit_dsevent">
			...
			<fieldset style="padding:10"><legend>{$smarty.const.DS_GRAPH_PROPS}</legend>
				...
				<table style="margin:5 0" cellspacing="3" width="100%">
					...
					<tr>
						...
						<td nowrap valign="top">{$smarty.const.DS_GRAPH_WIDTH} <input type="text" name="ixmin" id="f_ixmin" size="4" disabled>&nbsp;&nbsp;{$smarty.const.DS_GRAPH_HEIGHT} <input type="text" id="f_iymin" name="iymin" size="4" disabled></td>
					</tr>
					<tr>
