...
<title><?=is_array($obj) ? EDIT_OBJECTS_AUTHS : EDIT_OBJECT_AUTHS.' | '.$obj->name?></title>
<link href="../<?=SKIN?>.css" type=text/css rel=stylesheet>
<script language="JavaScript" type="text/JavaScript">
function dsb(){
	if(<?= ($multiple ? true : WCS::decide($obj, 'editobj.chmod')) ? 'false' : 'true'?>)
...
<form name="f" method="POST" action="i_security.php">
	...
	<table style="margin:5 0" cellspacing="3" id="auths">
		...
		<?	endforeach;
			...
			<tr>
				<td title='Key: <?=$act?>'><?=$title?></td>
				<td align="middle"><? ctl("oAuths[$act]", $obj[0]->sRes->getOwnerBit($act), $obj[1]->sRes->getOwnerBit($act))?></td>
				<td align="middle"><? ctl("gAuths[$act]", $obj[0]->sRes->getGroupBit($act), $obj[1]->sRes->getGroupBit($act))?></td>
			</tr>
		<?	endforeach;
		endif;
