 ...
 * 
 * $Id: publicationlistintro.php,v 1.9 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_publication.php">
	<input type="hidden" name="action" value="edit_publicationlistintro">
	...
	<table style="margin:5 0" cellspacing="3">
		...
		<tr>
			...
			<td><textarea cols="51" rows="5" name="description" onpropertychange="dsb()"><?=$obj->description?></textarea></td>
		</tr>
	</table>
	</fieldset><br>
<?
