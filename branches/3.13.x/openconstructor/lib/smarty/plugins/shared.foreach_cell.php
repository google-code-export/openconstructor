...
class Smarty_Foreach_Cell {
	...
	function col_open($tag_args, &$compiler) {
		return self::row_open($tag_args, $compiler, true);
	}
	
	function col_close($tag_args, &$compiler) {
		return self::row_close($tag_args, $compiler, true);
	}
	...
	function &_getNew($flip) {
		return self::_registry(SFC_REG_GET_NEW, $flip);
	}
	
	function &_getLast() {
		return self::_registry(SFC_REG_GET_LAST);
	}
	
	function &_destoyLast() {
		return self::_registry(SFC_REG_DESTROY_LAST);
	}
