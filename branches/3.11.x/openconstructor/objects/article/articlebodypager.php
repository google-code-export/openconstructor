 ...
 * 
 * $Id: articlebodypager.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<body style="border-style:groove;padding:0 20 20" onload="">
<br>
<h3><?=EDIT_OBJECT?></h3>
<form name="f" method="POST" action="i_article.php">
	<input type="hidden" name="action" value="edit_articlebodypager">
