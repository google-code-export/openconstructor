 ...
 * 
 * $Id: publicationpager.php,v 1.7 2007/03/02 10:06:41 sanjar Exp $
 */
...
<form name="f" method="POST" action="i_publication.php">
	<input type="hidden" name="action" value="edit_publicationpager">
...
<?
	...
	$types=array('publicationhl','publicationhlintro','publicationlist','publicationlistintro');
